...
var Emitter = /** @class */ (function () {
    ...
    Object.defineProperty(Emitter.prototype, "totalListener", {
        /** 获取侦听器总数 */
        get: function () {
            return Object.values(this.listeners).reduce(function (pre, current) { return pre + current.length; }, 0);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Emitter.prototype.addListener = function (type, handler, context, count, catchFeature) {
        ...
        this.listeners[type].push(Listener.create(type, handler, this, context, count, catchFeature));
        return true;
    };
    /**
     * 添加侦听器
